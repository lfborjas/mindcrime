...
{var obj = {};
var G__7160_7162 = cljs.core.seq.call(null,x);
while(true){
if(G__7160_7162)
{var vec__7161_7163 = cljs.core.first.call(null,G__7160_7162);
var k_7164 = cljs.core.nth.call(null,vec__7161_7163,0,null);
var v_7165 = cljs.core.nth.call(null,vec__7161_7163,1,null);
(obj[clj__GT_js.call(null,k_7164)] = clj__GT_js.call(null,v_7165));
{
var G__7166 = cljs.core.next.call(null,G__7160_7162);
G__7160_7162 = G__7166;
continue;
}
} else
{}
...
return cljs.core.remove.call(null,(function (p1__7167_SHARP_){
return clojure.string.blank_QMARK_.call(null,p1__7167_SHARP_);
}),clojure.string.split.call(null,raw_markup,/!SLIDE/));
});
var render_slide = (function render_slide(mkp){
return mindcrime.render.call(null,"markdown_slide",cljs.core.ObjMap.fromObject(["\uFDD0'content"],{"\uFDD0'content":mkp}));
});
...
return render_slideshow.call(null,rendered_slides.call(null,split_slides.call(null,read_slides.call(null,from_filename))));
});
...
var G__7169_7170 = mindcrime.app;
G__7169_7170.use(mindcrime.express.logger());
G__7169_7170.use(mindcrime.express['static']('./public'));
G__7169_7170.get("/",mindcrime.create_slideshow);
G__7169_7170.listen(port);
...
_serve.cljs$lang$applyTo = (function (arglist__7171){
var args = cljs.core.seq(arglist__7171);;
