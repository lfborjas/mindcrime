...
{var obj = {};
var G__10256_10258 = cljs.core.seq.call(null,x);
while(true){
if(G__10256_10258)
{var vec__10257_10259 = cljs.core.first.call(null,G__10256_10258);
var k_10260 = cljs.core.nth.call(null,vec__10257_10259,0,null);
var v_10261 = cljs.core.nth.call(null,vec__10257_10259,1,null);
(obj[clj__GT_js.call(null,k_10260)] = clj__GT_js.call(null,v_10261));
{
var G__10262 = cljs.core.next.call(null,G__10256_10258);
G__10256_10258 = G__10262;
continue;
}
} else
{}
...
return cljs.core.map.call(null,(function (p__10272){
var vec__10273 = p__10272;
var _ = cljs.core.nth.call(null,vec__10273,0,null);
var t = cljs.core.nth.call(null,vec__10273,1,null);
var mkp = cljs.core.nth.call(null,vec__10273,2,null);
...
var render_slide = (function render_slide(p__10274){
...
var typ = cljs.core._lookup.call(null,map__10276__$1,"\uFDD0'type",null);
var mkp = cljs.core._lookup.call(null,map__10276__$1,"\uFDD0'content",null);
...
return render_slideshow.call(null,rendered_slides.call(null,build_slides.call(null,split_slides.call(null,read_slides.call(null,from_filename)))));
});
...
var G__10278_10279 = mindcrime.app;
G__10278_10279.use(mindcrime.express.logger());
G__10278_10279.use(mindcrime.express['static']('./public'));
G__10278_10279.get("/",mindcrime.create_slideshow);
G__10278_10279.listen(port);
...
_serve.cljs$lang$applyTo = (function (arglist__10280){
var args = cljs.core.seq(arglist__10280);;
