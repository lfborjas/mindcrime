...
cljs.core.derive = function() {
  var a = null, b = function(b, c) {
    if(!cljs.core.truth_(cljs.core.namespace.call(null, c))) {
      throw Error([cljs.core.str("Assert failed: "), cljs.core.str(cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'namespace", "\ufdd1'parent"), cljs.core.hash_map("\ufdd0'line", 6984))))].join(""));
    }
    cljs.core.swap_BANG_.call(null, cljs.core.global_hierarchy, a, b, c);
    return null
  }, c = function(a, b, c) {
    if(!cljs.core.not_EQ_.call(null, b, c)) {
      throw Error([cljs.core.str("Assert failed: "), cljs.core.str(cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'not=", "\ufdd1'tag", "\ufdd1'parent"), cljs.core.hash_map("\ufdd0'line", 6988))))].join(""));
    }
...
mindcrime.slurp = function(a) {
  return"" + cljs.core.str(mindcrime.fs.readFileSync(a))
};
mindcrime.clj__GT_js = function clj__GT_js(b) {
  if(cljs.core.string_QMARK_.call(null, b)) {
    return b
  }
  ...
  if(cljs.core.map_QMARK_.call(null, b)) {
    for(var c = {}, b = cljs.core.seq.call(null, b);;) {
      if(b) {
        ...
        c[clj__GT_js.call(null, e)] = clj__GT_js.call(null, d);
        b = cljs.core.next.call(null, b)
      }else {
        break
      }
...
mindcrime.render = function(a, b) {
  return mindcrime.engine.compile(mindcrime.slurp.call(null, [cljs.core.str("./views/"), cljs.core.str(a), cljs.core.str(".html")].join(""))).call(null, mindcrime.clj__GT_js.call(null, b))
};
mindcrime.slideshow = function(a) {
  var b = function(a) {
    var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core._lookup.call(null, b, "\ufdd0'type", null), b = cljs.core._lookup.call(null, b, "\ufdd0'content", null);
    return mindcrime.render.call(null, [cljs.core.str(a), cljs.core.str("_slide")].join(""), cljs.core.ObjMap.fromObject(["\ufdd0'content"], {"\ufdd0'content":b}))
  };
  return function(a) {
    return mindcrime.render.call(null, "index", cljs.core.ObjMap.fromObject(["\ufdd0'slides"], {"\ufdd0'slides":a}))
  }.call(null, function(a) {
    return cljs.core.map.call(null, b, a)
  }.call(null, function(a) {
    return cljs.core.map.call(null, function(a) {
      cljs.core.nth.call(null, a, 0, null);
      var b = cljs.core.nth.call(null, a, 1, null), a = cljs.core.nth.call(null, a, 2, null);
      return cljs.core.ObjMap.fromObject(["\ufdd0'type", "\ufdd0'content"], {"\ufdd0'type":cljs.core.truth_(b) ? b : "markdown", "\ufdd0'content":a})
    }, a)
  }.call(null, function(a) {
    cljs.core.println.call(null, a);
    return a
  }.call(null, function(a) {
    return cljs.core.concat.call(null, cljs.core.map.call(null, function(a) {
      return cljs.core.re_seq.call(null, /\s*(html|markdown)?([\s\S])+/, a)
    }, clojure.string.split.call(null, a, /!SLIDE/)))
  }.call(null, function(a) {
    return mindcrime.slurp.call(null, a)
  }.call(null, a))))))
};
mindcrime.create_slideshow = function(a, b) {
  return b.send(mindcrime.slideshow.call(null, "./slides.md"))
};
mindcrime._serve = function() {
  var a = function() {
    ...
    b.use(mindcrime.express["static"]("./public"));
    b.get("/", mindcrime.create_slideshow);
    b.listen(a);
